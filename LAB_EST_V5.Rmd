---
title: "Grupo II - Avaliação de indicadores de práticas de saúde em relação a variáveis
  socioeconômicas"
output:
  pdf_document:
    toc: true
...
pse_2023 <- read_excel("DadosAtividadesePop/Saúde na Escola/Produção do PSE/producao_pse_2023.xlsx", 
                                skip = 8, n_max = 5360)


prom_saude_2023 <- read_excel("DadosAtividadesePop/grupo 2 Práticas para a Saúde/praticas2023.xlsx", 
                           skip = 10, n_max = 5240)

temas_saude_2023 <- read_excel("DadosAtividadesePop/grupo 1 Temas para a Saúde/temas2023.xlsx", 
                        skip = 10)

escolas_adesao_2023_2024 <- read_excel("DadosAtividadesePop/Saúde na Escola/Escolas com Adesão - Denominador/escolas_adesao_2023_2024.xlsx", 
                                       skip = 4)
...
caminho <- "DadosAtividadesePop/Bolsa Família/Bfa_Consolidado-geral-22023-porMunicipio.xls"

dados_brutos <- read_html(caminho, encoding = "ISO-8859-1") |>
  html_element("table") |>            # primeira (e única) tabela da página
  html_table(fill = TRUE)

bolsa_familia_2023 <- dados_brutos |>
  clean_names() |>                     # nomes em snake_case
...
PIB_EST_PC <- read_excel('UF_Renda_Per_Capita.xlsx')
```
...
#prom_saude_2023 <- prom_saude_2023 %>%rename('IBGE' = 'Ibge','Praticas_atividades_corporais' = 'Práticas.corporais...atividade','Verific_sit_vacina' = 'Verificação.da.situação.vacina')

#pop_cad_2023 <- pop_cad_2023%>%rename('POP_CADASTRADA_IBGE' ='Qt..Total.de.cadastros...limitado.pela.população.IBGE.','Regiao' = 'Região')

#pop_cad_2023 <- pop_cad_2023 %>%filter(POP_CADASTRADA_IBGE > 0)

#pse_2023 <- pse_2023 %>%rename('IBGE' = 'Ibge')

#temas_saude_2023 <- temas_saude_2023 %>%rename('IBGE' = 'Ibge','auto_cuid_doenc_cronic' = 'Autocuidado.de.pessoas.com.doe','Saude_reprodut' = 'Saúde.sexual.e.reprodutiva','Saude_bucal' = 'Saúde.bucal','Aliment_saudav' = 'Alimentação.saudável','Saude_mental' = 'Saúde.mental')

#Bolsa_familia_2023 <- Bolsa_familia_2023 %>%rename('perc_cob_ben_acomp' ='Perc..cobertura.de.beneficiários.acompanhados....','UF_SIGLA' = 'Estado')

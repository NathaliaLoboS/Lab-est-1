...
base_pratic_saude_2023 <- base_pratic_saude_2023 %>%
  ...
  select('Regiao', 'UF', 'UF_SIGLA', 'IBGE', 'Município', 'Municipio_UF', 'População', 'POP_CADASTRADA_IBGE', 'Cobertura.APS', 'Antropometria', 'Praticas_atividades_corporais',
'Verific_sit_vacina')
...
ind_temas_saude <- base_temas_saude_2023 %>%
  mutate(Pais = 'Brasil',
        ind_saude_bucal = ((Saude_bucal / POP_CADASTRADA_IBGE) * 100000),
  ...
  select(UF, Pais, IBGE, UF_SIGLA ,Município, Municipio_UF, Regiao, ind_saude_bucal, ind_Aliment_saudav, ind_Saude_reprodut, ind_Saude_mental, ind_auto_cuid_doenc_cronic, Saude_bucal,
Aliment_saudav, Saude_reprodut, Saude_mental, auto_cuid_doenc_cronic,
POP_CADASTRADA_IBGE)
...
ind_praticas_saude <- base_pratic_saude_2023 %>%
  mutate(Pais = 'Brasil', 
    ind_Antropometria = ((Antropometria / POP_CADASTRADA_IBGE) * 100000),
  ...
  select(UF, Pais, IBGE, UF_SIGLA, Município, Municipio_UF, Regiao, ind_Antropometria, ind_Praticas_atividades_corporais, ind_Verific_sit_vacina, Antropometria, Praticas_atividades_corporais, Verific_sit_vacina, POP_CADASTRADA_IBGE)

#write.xlsx(ind_praticas_saude, "ind_praticas_saude.xlsx")
```
...
ind_adesão_escolas <- base_adesão_escolas_pse_2023 %>%
  ...
  select(UF, Pais, IBGE, MUNICÍPIO, UF_SIGLA, Municipio_UF, QTD_escolas, Regiao, ind_Educação, Educação, Saúde, ind_Saúde)
...
ggplot(ind_temas_saude,
  ...
  labs(x = "Qtd. de Atividades coletivas de saúde bucal por 100 mil habitantes",
...
geom_boxplot() +
labs(
  title = "Indicador de Qtd. de ativ. coletivas de Saúde Bucal - Por Regiões", 
  subtitle = "Ano: 2023", 
...
scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Qtd. de ativ. coletivas de saúde Bucal",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
...
ggplot(ind_temas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Qtd. de ativ. coletivas práticas saúde mental por 100 mil habitantes",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador de Qtd. de ativ. coletivas de Saúde mental - Por Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y=""
) +
...
scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Qtd. de ativ. coletivas Saúde Mental",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
# 5.3 Indicadores de Qtd. de ativ. coletivas Alimentação saudável {.tabset}
...
ggplot(ind_temas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Qtd. de ativ. coletivas Alimentação saudável por 100 mil habitantes",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicaor de ativ. coletivas Alimentação saudável - Por Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y=""
) +
...
ggplot(
  ...
  scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Qtd. Atividades coletivas de Alimentação saudável",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
# 5.4 Indicadores de quantitativo de atividades coletivas de saúde sexual e reprodutiva (SSR) {.tabset}
...
ggplot(ind_temas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador de Quant. de Atividades Coletivas SSR por 100 mil habitantes",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador Quant. de Atividades Coletivas SSR - Por Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y = ""
) +
...
ggplot(
  ...
  scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Indicador Qtd. atividades coletivas SSR",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
ind_temas_saude %>%
  summarise(
    ...
    Max = round(max(ind_auto_cuid_doenc_cronic, na.rm = TRUE), 2),
    Pvalor_shapiro = ifelse(
      sum(!is.na(ind_auto_cuid_doenc_cronic)) >= 3,
      round(tryCatch(shapiro.test(ind_auto_cuid_doenc_cronic)$p.value, error = function(e) NA), 5),
      NA
    ),
    Numerador = sum(ind_auto_cuid_doenc_cronic),
    Denominador = sum(POP_CADASTRADA_IBGE),
    num_municip = n()
  ) %>%
  kable(
...
ggplot(ind_temas_saude,
       aes(x = ind_Saude_reprodut, fill = Regiao)) +
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador de Quantitativo atividades coletivas SSR 100 mil habitantes",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador Quantitativo ativ. coletivas SSR - Por Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y=""
) +
...
# 5.6 Indicadores de atividades coletivas de Antropometria {.tabset}
...
ggplot(ind_praticas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador de quantidade atividades coletivas de Antropometria",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador de atividades coletivas de Antropometria - Por Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y=""
) +
...
ggplot(
  ...
  scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Indicador de qtd atividades coletivas de Antropometria",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
# 5.7 Indicadores de Práticas de atividades corporais {.tabset}
...
ggplot(ind_praticas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indice atividades coletivas de atividades corporais",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Ind. de qtd. de ativ coletiv. de pratica de ativ corporais. -  Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde"
) +
theme_bw() +
...
ggplot(
  ...
  scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Qtd. ativ. colet. práticas corporais",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
# 5.8 Indicadores atividades coletivas de verificação de saúde Vacinal {.tabset}
...
ggplot(ind_praticas_saude,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador qtd. ativ. coletiva - verificação situação Vacinal",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador qtd. ativ. coletiva - verificação situação Vacinal", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde"
) +
theme_bw() +
...
ggplot(
  ...
  scale_y_continuous(labels = label_number(big.mark = ".", decimal.mark = ",")) +
  labs(
    title = "Top 10 Municípios - Ind. qtd. ativ. coletiv. verific. sit. vacinal",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
    caption = "Fonte: Ministério da Saúde - Números para 100.000 habitantes"
...
# 5.9 Indicador de adesão ao Programa Saúde na Escola (PSE) {.tabset}
...
ggplot(ind_adesão_escolas,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador adesão ao programa de saude nas escolas (PSE)",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
ggplot(
  ...
  labs(
    title = "Top 10 Municípios - Promoção a saúde: adesão ao Prog. de saúde nas escolas - PSE",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
  ) +
...
# 5.10 Indicadores quantidades de atividades coletivas nas escolas {.tabset}
...
ggplot(ind_adesão_escolas,
  ...
  geom_histogram(alpha = 0.5, bins = 40, position = "identity") +
  labs(x = "Indicador Quantidade de atividades coletivas nas escolas (PSE)",
     y = "Número de municípios") +
  theme_minimal()+
  theme(
    legend.position = "bottom",
...
geom_boxplot() +
labs(
  title = "Indicador de Qtd de ativ. coletivas nas escolas (PSE) - Regiões", 
  subtitle = "Ano: 2023", 
  caption = "Fonte: Ministério da Saúde",
  y=""
) +
...
ggplot(
  ...
  scale_y_continuous(labels = comma)+
  labs(
    title = "Top 10 Municípios - Ind. Qtd. atividades coletivas nas escolas",
    subtitle = "Ano: 2023",
    x = "Município",
    y = "Indicador",
  ) +
...
correl_Indicador_saude_bucal_PIB_EST_PC = round(cor(UF_ind_temas_saude$Indicador_saude_bucal, UF_ind_temas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Indicador_Aliment_saudav_PIB_EST_PC = round(cor(UF_ind_temas_saude$Indicador_Aliment_saudav, UF_ind_temas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Indicador_saude_mental_PIB_EST_PC = round(cor(UF_ind_temas_saude$Indicador_saude_mental, UF_ind_temas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Indicador_saude_reprodut_PIB_EST_PC = round(cor(UF_ind_temas_saude$Indicador_saude_reprodut, UF_ind_temas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Indicador_auto_cuidad_PIB_EST_PC = round(cor(UF_ind_temas_saude$Indicador_auto_cuidad, UF_ind_temas_saude$PIB_EST_PC, method = "spearman"),2)
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_bucal, y = IDHM)) +
  ...
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Bucal e IDHM",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_bucal, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saude Bucal e GINI",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_bucal, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saude Bucal e PIB",
    x = "Indicador de Saúde Bucal (por 100 mil habitantes)",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_bucal, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_saude_bucal_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação Indicador qtd. ativ. coletiv. de Saude Bucal e PIB estadual Per capita",
    x = "Indicador de Saúde Bucal (por 100 mil habitantes)",
    y = "PIB Per Capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_bucal, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saude Bucal e IVS",
    x = "Indicador de Saúde Bucal (por 100 mil habitantes)",
    y = "IVS"
  ) +
  theme_minimal() +
...
# 5.15 Indicadores de alimentação saudável e socioeconômicos {.tabset}
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_Aliment_saudav, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Alimentação saudável e IDHM",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_Aliment_saudav, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Alimentação saudável e GINI",
    x = "Indicador de Alimentação saudável (por 100 mil habitantes)",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_Aliment_saudav, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. Alimentação saudável e PIB",
    x = "Indicador de Alimentação Saudável (por 100 mil habitantes)",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Alimentação Saudável X PIB per Capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_temas_saude, aes(x = Indicador_Aliment_saudav, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Aliment_saudav_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Alimentação saudável e PIB per capita",
    x = "Indicador de Alimentação Saudável (por 100 mil habitantes)",
    y = "PIB Per Capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_Aliment_saudav, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Alimentação saudável e IVS",
    x = "Indicador de Alimentação saudável (por 100 mil habitantes)",
    y = "IVS"
  ) +
  theme_minimal() +
...
# 5.16 Indicadores de Saude Mental e socioeconômicos {.tabset}
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_mental, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde mental e IDHM",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_mental, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Mental e GINI",
    x = "Indicador de Saúde mental (por 100 mil habitantes)",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_mental, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde mental e PIB",
    x = "Indicador de saúde mental (por 100 mil habitantes)",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Saúde Mental X PIB Per Capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_mental, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_saude_mental_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde mental e PIB per capita",
    x = "Indicador de saúde mental (por 100 mil habitantes)",
    y = "PIB Per Capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_mental, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde ental e IVS",
...
# 5.17 Indicadores de Saude Reprodutiva e socioeconômicos {.tabset}

## Saúde Reprodutiva X IDHM
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_reprodut, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde reprodutiva e IDHM",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_reprodut, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Reprodutiva e GINI",
    x = "Indicador de Saúde reprodutiva (por 100 mil habitantes)",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_reprodut, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Reprodutiva e PIB",
    x = "Indicador de saúde Reprodutiva (por 100 mil habitantes)",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Saúde reprodutiva X PIB Per Capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_reprodut, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_saude_reprodut_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Reprodutiva e PIB per Capita",
    x = "Indicador de saúde Reprodutiva (por 100 mil habitantes)",
    y = "PIB Per Capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_saude_reprodut, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Saúde Reprodutiva e IVS",
...
# 5.18 Indicadores de auto cuidado e socioeconômicos {.tabset}
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_auto_cuidad, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de auto cuidado e IDHM",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_auto_cuidad, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de auto cuidado e GINI",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_auto_cuidad, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de auto cuidado e PIB",
    x = "Indicador de auto cuidado (por 100 mil habitantes)",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_auto_cuidad, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_auto_cuidad_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de auto cuidado e PIB",
    x = "Indicador de auto cuidado (por 100 mil habitantes)",
...
ggplot(UF_ind_temas_saude, aes(x = Indicador_auto_cuidad, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de auto cuidado e IVS",
    x = "Indicador de auto cuidado (por 100 mil habitantes)",
    y = "IVS"
  ) +
  theme_minimal() +
...
# 5.19 Indicadores de Antropometria socioeconômicos
...
correl_Indicador_Antropometria_PIB_EST_PC = round(cor(UF_ind_praticas_saude$Indicador_Antropometria, UF_ind_praticas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Ind_Prat_ativ_corp_PIB_EST_PC = round(cor(UF_ind_praticas_saude$Ind_Prat_ativ_corp, UF_ind_praticas_saude$PIB_EST_PC, method = "spearman"),2)
...
correl_Ind_verif_vacina_PIB_EST_PC = round(cor(UF_ind_praticas_saude$Ind_verif_vacina, UF_ind_praticas_saude$PIB_EST_PC, method = "spearman"),2)

#write.xlsx(UF_ind_praticas_saude, "UF_ind_praticas_saude.xlsx")
```
...
# 5.20 Indicadores de pratica de atividade corporal socioeconômicos {.tabset}
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_Prat_ativ_corp, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Prática corporal e IDHM",
    x = "Indicador (por 100 mil habitantes)",
    y = "IDHM"
  ) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_Prat_ativ_corp, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ. coletiv. de Pratica corporal e GINI",
    x = "Indicador",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_Prat_ativ_corp, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre qtd. ativ. coletiv. atividade corporal e PIB",
    x = "Indicador",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Prática corporal X PIB per Capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_praticas_saude, aes(x = Ind_Prat_ativ_corp, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Ind_Prat_ativ_corp_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. e PIB Per Capita",
    x = "Indicador",
    y = "PIB per Capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_Prat_ativ_corp, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de prática corporal e IVS",
    x = "Indicador",
    y = "IVS"
  ) +
  theme_minimal() +
...
# 5.21 Indicadores Verificação vacinal e socioeconômicos {.tabset}
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_verif_vacina, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Verificação vacinal e IDHM",
    x = "Indicador",
    y = "IDHM"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_verif_vacina, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Verificação vacinal e GINI",
    x = "Indicador",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_verif_vacina, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. Verificação vacinal e PIB",
    x = "Indicador",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Verificação Vacinal X PIB per capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_praticas_saude, aes(x = Ind_verif_vacina, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Ind_verif_vacina_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. Verificação vacinal e PIB per capita",
    x = "Indicador",
    y = "PIB per capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Ind_verif_vacina, y = IVS)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Verificação vacinal e IVS",
    x = "Indicador",
    y = "IVS"
  ) +
  theme_minimal() +
...
# 5.22 Indicadores de Antropometria e socioeconômicos {.tabset}

## Antropometria X IDHM

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_praticas_saude, aes(x = Indicador_Antropometria, y = IDHM)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Antropometria_IDHM,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Antropometria e IDHM",
    x = "Indicador",
    y = "IDHM"
  ) +
  theme_minimal() +
...
## Antropometria X GINI

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_praticas_saude, aes(x = Indicador_Antropometria, y = GINI)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Antropometria_GINI,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Antropometria e GINI",
    x = "Indicador",
    y = "GINI"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Indicador_Antropometria, y = PIB/1000000)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Antropometria_PIB,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. Antropometria e PIB",
    x = "Indicador",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Antropometria X PIB per capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_praticas_saude, aes(x = Indicador_Antropometria, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Antropometria_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. Antropometria e PIB per capita",
    x = "Indicador",
    y = "PIB per capita"
  ) +
  theme_minimal() +
...
ggplot(UF_ind_praticas_saude, aes(x = Indicador_Antropometria, y = IVS)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Antropometria_IVS,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador de qtd. ativ. coletiv. de Antropometria e IVS",
    x = "Indicador",
    y = "IVS"
  ) +
  theme_minimal() +
...
correl_Indicador_Educacao_PIB_EST_PC = round(cor(UF_ind_adesao_escolas$Indicador_Educacao, UF_ind_adesao_escolas$PIB_EST_PC, method = "spearman"),2)
...
correl_Indicador_Saude_PIB_EST_PC = round(cor(UF_ind_adesao_escolas$Indicador_Saude, UF_ind_adesao_escolas$PIB_EST_PC, method = "spearman"),2)
...
ggplot(UF_ind_adesao_escolas, aes(x = Indicador_Educacao, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           label = paste0("Correlação: ", round(correl_Indicador_Educacao_PIB_EST_PC,2)),
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
...
# 5.23 Indicadores de Saúde nas escolas socioeconômicos {.tabset}

## Práticas Saúde nas escolas X IDHM
...
ggplot(UF_ind_adesao_escolas, aes(x = Indicador_Saude, y = IDHM)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ coletivas de saúde nas escolas e IDHM",
    x = "Indicador",
    y = "IDHM"
  ) +
  theme_minimal() +
...
## Práticas Saúde nas escolas X GINI
...
ggplot(UF_ind_adesao_escolas, aes(x = Indicador_Saude, y = GINI)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ coletivas de saúde nas escolas e GINI",
    x = "Indicador",
    y = "GINI"
  ) +
  theme_minimal() +
...
## Práticas Saúde nas escolas X PIB
...
ggplot(UF_ind_adesao_escolas, aes(x = Indicador_Saude, y = PIB/1000000)) +
  ...
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ coletivas de saúde nas escolas e PIB",
    x = "Indicador",
    y = "PIB (em bilhões de reais)"
  ) +
  theme_minimal() +
...
## Práticas Saúde nas escolas X PIB per capita

```{r, echo=FALSE, warning=FALSE, message=FALSE, fig.height=4, fig.width=12}

ggplot(UF_ind_adesao_escolas, aes(x = Indicador_Saude, y = PIB_EST_PC)) +
  geom_point(color = "darkblue", size = 3) +
  geom_smooth(method = "lm", se = FALSE, color = "red", linetype = "dashed") +
  annotate("text", x = Inf, y = -Inf, 
           ...
           hjust = 1.1, vjust = -1.1, size = 4, fontface = "italic", color = "black") +
  labs(
    title = "Relação entre Indicador qtd. ativ coletivas de saúde nas escolas e PIB per capita",
    x = "Indicador",
    y = "PIB per capita"
  ) +
  theme_minimal() +
...
## Práticas Saúde nas escolas X IVS
...
dataset_correlacao <- rbind(correl_temas_saude, correl_praticas_saude,
                            correl_Bolsa_Familia, correl_adesao_escolas)
...
dataset_looker_pt1 <- ind_adesão_escolas %>%
  ...
  select(Pais, IBGE, UF_SIGLA, UF_SIGLA_BR, Municipio_UF, Regiao, ind_Educação, ind_Saúde) %>%
  pivot_longer(cols = c(ind_Educação, ind_Saúde),
               names_to = "Desc_Indicador",
               values_to = "Indicador")

dataset_looker_pt2 <- ind_praticas_saude %>%
  mutate(UF_SIGLA_BR = str_c("BR", UF_SIGLA, sep = "-"))%>%
  select(Pais, IBGE, UF_SIGLA, UF_SIGLA_BR, Municipio_UF, UF_SIGLA, 
         Regiao, ind_Antropometria, ind_Praticas_atividades_corporais, ind_Verific_sit_vacina) %>%
  pivot_longer(cols = c(ind_Antropometria, ind_Praticas_atividades_corporais, ind_Verific_sit_vacina),
               names_to = "Desc_Indicador",
               values_to = "Indicador")

dataset_looker_pt3 <- ind_temas_saude %>%
  mutate(UF_SIGLA_BR = str_c("BR", UF_SIGLA, sep = "-"))%>%
  select(Pais, IBGE, UF_SIGLA, UF_SIGLA_BR, Municipio_UF, UF_SIGLA,
         Regiao, ind_Aliment_saudav, ind_saude_bucal, auto_cuid_doenc_cronic,
         ind_Saude_mental, ind_Saude_reprodut) %>%
  pivot_longer(cols = c(ind_Aliment_saudav, ind_saude_bucal, auto_cuid_doenc_cronic,
         ind_Saude_mental, ind_Saude_reprodut),
               names_to = "Desc_Indicador",
               values_to = "Indicador")

dataset_looker_pt4 <- Bolsa_familia_2023 %>%
  mutate(UF_SIGLA_BR = str_c("BR", UF_SIGLA, sep = "-"))%>%
  select(Pais, IBGE, UF_SIGLA, UF_SIGLA_BR, Municipio_UF, Regiao, perc_cob_ben_acomp) %>%
  pivot_longer(cols = c(perc_cob_ben_acomp),
               names_to = "Desc_Indicador",
               values_to = "Indicador")

dataset_looker_pt5 <- bind_rows(
  dataset_looker_pt1,
  dataset_looker_pt2,
  dataset_looker_pt3,
  dataset_looker_pt4
...
dataset_looker_pt6 <- dataset_looker_pt5 %>%
  inner_join(IDHM_Municipios, by = c("IBGE", "UF_SIGLA"))%>%
  select(Pais, IBGE, UF_SIGLA, Municipio_UF, UF_SIGLA_BR, Regiao, Desc_Indicador, Indicador, IDHM_2010)

dataset_looker_pt7 <- dataset_looker_pt6%>%
  inner_join(PIB_PER_CAPITA_MUNICIP, by = c("IBGE", "UF_SIGLA"))

dados_unificados <- dataset_looker_pt7 %>%
  select(Pais, IBGE, UF_SIGLA, Municipio_UF, UF_SIGLA_BR, Regiao, Desc_Indicador, Indicador, IDHM_2010, PIB_per_capita) %>%
  pivot_longer(cols = c(IDHM_2010, PIB_per_capita),
               names_to = "Desc_Indicador_socioeconomico",
               values_to = "Indicador_socioeconomico")

dataset_looker_pt6 <- dataset_looker_pt5 %>%
  inner_join(IDHM_Municipios, by = c("IBGE", "UF_SIGLA"))%>%
  select(Pais, IBGE, UF_SIGLA, Municipio_UF, Regiao, UF_SIGLA_BR, Desc_Indicador, Indicador, IDHM_2010)

dataset_looker_pt7 <- dataset_looker_pt6%>%
  inner_join(PIB_PER_CAPITA_MUNICIP, by = c("IBGE", "UF_SIGLA"))

dados_unificados <- dataset_looker_pt7 %>%
  select(Pais, IBGE, UF_SIGLA, Municipio_UF, Regiao, UF_SIGLA_BR, Desc_Indicador, Indicador, IDHM_2010, PIB_per_capita) %>%
  pivot_longer(cols = c(IDHM_2010, PIB_per_capita),
               names_to = "Desc_Indicador_socioeconomico",
               values_to = "Indicador_socioeconomico")
...
dataset_looker_ind_escolas <- ind_adesão_escolas %>%
    mutate(UF_SIGLA_BR = str_c("BR", UF_SIGLA, sep = "-"))%>%
  select(UF, Pais, IBGE, UF_SIGLA, UF_SIGLA_BR, Municipio_UF, Regiao, QTD_escolas, 
         Educação, Saúde) %>%
  pivot_longer(cols = c(Educação, Saúde),
               names_to = "Desc_Indicador",
               values_to = "Indicador")
